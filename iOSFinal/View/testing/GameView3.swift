...
//animation
    ...
    @State private var receiveTimer = Timer.publish(every: 0.5, on: .main, in: .common).autoconnect()
...
//中間桌以下/////////////
            Group{
                ...
                VStack {
                    ...
                    //.offset(x: -350+dragValue.width * 0.1, y: 50+dragValue.height * 0.1)
...
//
                ...
                myOffset.width += (dragValue.width * 0.5)
                myOffset.height += (dragValue.height * 0.5)
...
struct GameView3_Previews: PreviewProvider {
    static var previews: some View {
        GameView3(roomDocumentName: .constant("Room2"))
